                      ...
                      <div className="ai-analysis-content">
                        ...
                        <div className="ai-analysis-grid">
                          {topSections.map(section => {
                            const meta = sectionMeta[section.title] || { color: '#6B7280', icon: BarChart2 };
                            const Icon = meta.icon;
                            return (
                              <div key={section.title} className="ai-analysis-card" style={{ '--section-color': meta.color }}>
                        ...
                        {bottomSection && (() => {
                          const meta = sectionMeta[bottomSection.title] || { color: '#7C3AED', icon: Sparkles };
                          const Icon = meta.icon;
                          return (
                            <div className="ai-analysis-card ai-analysis-next-step" style={{ '--section-color': meta.color }}>
                              <div className="ai-card-header">
                                <Icon size={15} />
