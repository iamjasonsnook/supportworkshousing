...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      console.log('Volunteer confirmation email sent to', requestData.contact_email);
    } catch (emailError) {
      console.error('Volunteer email send error:', emailError);
    }

    // Send property manager notification
    try {
      ...
      console.error('Property manager email send error:', emailError);
    }
